...
router.post("/posts/create", checkLogin, function (req, res, next) {
  res.send("发表文章");
});

// GET /posts/create 发表文章页
router.get("/posts/create", checkLogin, function (req, res, next) {
  res.send("发表文章页");
});
...
router.post("/comments/", checkLogin, function (req, res, next) {
  res.send("创建留言");
});

// GET /comments/:commentId/remove 删除一条留言
router.get("/comments/:commentId/remove", checkLogin, function (
  req,
  res,
  next
) {
...
// GET /signin 登录页
router.get("/signin/", checkLogin, function (req, res, next) {
  res.send("登录页");
});
...
// GET /signup 注册页
router.get("/signup/", checkLogin, function (req, res, next) {
  res.send("注册页");
});

// POST /signup 用户注册
router.post("/signup/", checkLogin, function (req, res, next) {
  res.send("注册");
});
...
运行 `npm run dev` 启动博客，访问以下地址查看效果：
